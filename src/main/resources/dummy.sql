...
-- 2️⃣ 유저 데이터 삽입
INSERT INTO users (email, password, nickname, image_url, coin, created_at, updated_at, status)
VALUES
    ('user1@gmail.com', 'password123', '도전왕', 'https://example.com/user1.jpg', 500, NOW(), NOW(), 'ACTIVE'),
    ('user2@gmail.com', 'password456', '절약왕', 'https://example.com/user2.jpg', 300, NOW(), NOW(), 'ACTIVE');
